...
private:
	...
	//DirectX::XMFLOAT4	color = DirectX::XMFLOAT4(1, 1, 1, 1);	// 白
	//DirectX::XMFLOAT4	color = DirectX::XMFLOAT4(1, 0, 0, 1);	// 赤
	DirectX::XMFLOAT4	color = DirectX::XMFLOAT4(1, 1, 1, 0.5f);	// 半透明の黒
};
